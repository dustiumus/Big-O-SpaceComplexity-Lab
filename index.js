...
function getNumbersSquared(numbers) {
  ...
  for (let d = 0; d < numbers.length; d++) {
    let circle = numbers[d] * numbers2[d]
    console.log(circle);
  }
  return squared
};
...
// ANSWER: 
// Broke down the functions, First countLetters() has the object already and is just verifying each property and counting them. Linear 
// countLettersRoundTwo is reading the info, creating new objects and then counting them. Exponential
